...
CREATE INDEX IF NOT EXISTS idx_journals_user_date_asc ON public.journals USING btree (user_id, entry_date);
CREATE INDEX IF NOT EXISTS idx_journals_user_date_desc ON public.journals USING btree (user_id, entry_date DESC);
CREATE INDEX IF NOT EXISTS idx_journals_deleted_at ON public.journals (deleted_at) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_attachments_journal ON public.journal_attachments USING btree (journal_id);
...
CREATE INDEX IF NOT EXISTS idx_achievements_journal ON achievements(journal_id);
CREATE INDEX IF NOT EXISTS idx_achievements_user ON achievements(user_id);
CREATE INDEX IF NOT EXISTS idx_achievements_date ON achievements(user_id, achieved_date DESC);
...
CREATE TABLE IF NOT EXISTS achievement_journals (
    id INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_achievement_journals_achievement ON achievement_journals(achievement_id);
CREATE INDEX IF NOT EXISTS idx_achievement_journals_journal ON achievement_journals(journal_id);

CREATE OR REPLACE VIEW journal_kpi_summary AS
SELECT
    j.user_id,
    u.team_id,
    j.kpi_period_id,
